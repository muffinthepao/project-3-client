...
function ProfileTest() {
  ...
  const [userDetails, setUserDetails] = useState(userData) // set initial useState
  ...
  const handleSubmit = async (event) => { // when you click update profile button
    event.preventDefault()
    console.log("userDetails: ", userDetails)
    
    try {
      
      let response = await axios.put( // run axios call to update in mongo.
